...
public class ManagePanel extends Composite {
	...
	public ManagePanel() {
	    ...
	    btnNew.addClickHandler(new ClickHandler() {
	    	public void onClick(ClickEvent event) {
	    		TestsData testsData1 = new TestsData("BAU Tests Secend", "New Test", Arrays.asList("New ParameterName"), Arrays.asList("New ParameterValue"), Arrays.asList("New ClassName"));
	    		testsData.add(testsData1);
	    		//provider.addDataDisplay(table);
	    	    int start = table.getVisibleRange().getStart();
	            int end = start + table.getVisibleRange().getLength();
