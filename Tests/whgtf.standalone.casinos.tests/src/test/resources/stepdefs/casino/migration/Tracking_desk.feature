...
Scenario Outline: Tracking_<Type>_<Brand>_<language>
    ...
    @WhccDeskTrackingEn @WhccAllMig
    Examples:
		| language | Brand | Type |  migUserAccount  					  | Advertiser | 
    	| en	   | Whcc  | Desk |  Wellcome to william hill casino club | yonam      |
    	
    @EgDeskTrackingEn @EgAllMig
    Examples:
   		| language | Brand | Type   |  migUserAccount  				     | Advertiser |  
    	| en	   | Eg    | Desk   |  Wellcome to Eurogrand casino club | yonam      |