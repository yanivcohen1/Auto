...
Scenario Outline: InnerPageNoRedirectToHP_<Type>_<Brand>_<language>
    ...
    Examples:
		| language | Brand | Type 	 | migUserName 	| Password| Home 									        			    | URL |
		| En	   | Whcc  | Mobi 	 | 170129033419 | 123456  | https://ww2.williamhillcasino.com/promotions?cat=most%20popular | https://ww2.williamhillcasino.com/en/promotions?cat=most%20popular |
#	@EgDeLogin
#    Examples:
