...
Feature: Deposit Mobile
  ...
  Scenario Outline: Deposit_<Type>_<Brand>_<language>
	...
	@WhccMobiDepositEn @WhccAllMig
    Examples:
		| language | Brand | Type |  RadioButten  														   |  freeSpins   | depositApproved 												  |  homeURL       	      |
    	| en	   | Whcc  | Mobi | I understand that my funds will be given a 'basic' level of protection |  free spins  |  Your deposit has been approved and will be charged as WH Online  | /en/?cat=Most-Popular |
    	
    @EgMobiDepositEn @EgAllMig
    Examples:
		| language | Brand | Type  | RadioButten  														    |  freeSpins   | depositApproved 												   |  homeURL 			   |
    	| en	   | Eg    | Mobi  | I understand that my funds will be given a 'basic' level of protection |  free spins  |  Your deposit has been approved and will be charged as WH Online  | /en/?cat=Most-Popular |
