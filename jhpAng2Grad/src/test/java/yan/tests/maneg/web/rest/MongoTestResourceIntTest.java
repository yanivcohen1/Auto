...
public class MongoTestResourceIntTest {
    ...
    public void setup() {
        ...
        final MongoTestResource mongoTestResource = new MongoTestResource(mongoTestRepository);
    ...
    public void equalsVerifier() throws Exception {
        ...
        mongoTest1.setId("id1");
        MongoTest mongoTest2 = new MongoTest();
        mongoTest2.setId(mongoTest1.getId());
        assertThat(mongoTest1).isEqualTo(mongoTest2);
        mongoTest2.setId("id2");
        assertThat(mongoTest1).isNotEqualTo(mongoTest2);
        mongoTest1.setId(null);
        assertThat(mongoTest1).isNotEqualTo(mongoTest2);
    }
}
