...
angular.module('ngSuitesManageAdminYeomanApp').controller('FileLoadCtrl',['$scope', '$log', '$window', '$http', '$q', '$resource', 'uiGridConstants', '$location', function ($scope, $log, $window, $http, $q, $resource, uiGridConstants, $location) {
