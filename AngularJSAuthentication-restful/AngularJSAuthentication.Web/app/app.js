var app = angular.module('exampleApp', ['ngRoute', 'ngCookies', 'exampleApp.services', 'ngTable', 'ngResource', 'ui.bootstrap', 'angular-loading-bar', 'ngAnimate'])
	.config(
		    ...
		    $httpProvider.interceptors.push(function ($q, $rootScope, $location) {
		        return {
		        	'request': function(config) {
		        		var isRestCall = config.url.indexOf(serviceBase + 'api') == 0;
...
services.factory('NewsService', function($resource) {
    ...
    return $resource(serviceBase + 'api/Suites/:id', { id: '@id' });
});

services.factory('SuiteService', function($resource) {
...
services.factory('TestService', function($resource) {
    ...
    return $resource(serviceBase + 'api/Tests/:id', { id: '@id' }, {
        update: {
            method: 'PUT' // this method issues a PUT request
          }
        });//, suite:'@suite'
