 ...
 */
app.controller('SuitesController', function ($scope, $filter, $modal, $log, SuiteService, suitesService, ngTableParams) {
    ...
    function readSuites() {
    	SuiteService.query(function(allSuties) {
        	   // success
        	suites = allSuties;
            $scope.data = allSuties;
