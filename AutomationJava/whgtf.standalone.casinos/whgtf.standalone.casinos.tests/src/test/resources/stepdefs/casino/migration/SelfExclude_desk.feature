...
Scenario Outline: SelfExclude_<Type>_<Brand>_<language>
	...
	#Start SelfExclude
	Given migUser is navigating to url "/responsible-gaming"
    ...
    @EgDeskSelfExcludeEn @EgAllMig
    Examples:
		| language | Brand | Type   |  UserAccount  						 | Msg 									 					  | Login_msg 																			 	      |
    	| En	   | Eg    | Desk   |  Wellcome to william hill casino club | I confirm that I have read and accepted the Self-Exclusion | Sorry, the action cannot be performed because you have asked to be self excluded from playing |
	
	@WhccDeskSelfExcludeEn @WhccAllMig
    Examples:
		| language | Brand | Type   |  UserAccount  						 | Msg 									 					  | Login_msg 																			 	      |
    	| En	   | Whcc  | Desk   |  Wellcome to william hill casino club | I confirm that I have read and accepted the Self-Exclusion | Sorry, the action cannot be performed because you have asked to be self excluded from playing |