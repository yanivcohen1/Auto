...
Scenario Outline: LoginPopup_<Type>_<Brand>_<language>
	...
	@WhccDeskLoginPopupEn @WhccAllMig
    Examples:
		| language | Brand | Type   | migUserName  | Password |LoginURL 								|
		| En	   | Whcc  | Desk   | 170129033419 | 123456   |https://www.williamhillcasino.com/login  |
...
#		| de	   | Whcc  | WhccMobileEnLogin.xml   | 151007020423 | 123456   |
	...
	@EgDeskLoginPopupEn @EgAllMig
    Examples:
		| language | Brand | Type	| migUserName 	| Password  | LoginURL 					  	  |
		| En	   | Eg    | Desk 	| 170129040528 | 123456     | https://www.eurogrand.com/login |
