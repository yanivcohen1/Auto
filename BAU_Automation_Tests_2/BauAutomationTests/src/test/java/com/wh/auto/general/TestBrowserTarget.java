...
public class TestBrowserTarget {
	...
	public static void main(String[] args) {
		...
		bt.browserTarget("http://www.eurogrand.com/", "fr", "http://www.eurogrand.com/fr", "ie");
		bt.after();
	}
	...
	@BeforeClass
	public void before() {
		String BrowserTargetFile = Utility.getFilePathFromResource("Eurogrand\\BrowserTarget.csv");
	...
	public Object[][] languages() {
		return new Object[][] {{"http://www.joylandcasino.com", "fr-CA", "http://www.joylandcasino.com/qc/", "chrome" }};//,
	 ...
	 * @param Browser
	 */
	@Test(dataProvider = "browserTarget2", description = "Test The Browser Targeting in Firefox")
