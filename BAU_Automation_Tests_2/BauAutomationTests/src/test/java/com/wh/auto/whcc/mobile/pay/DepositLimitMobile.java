...
public class DepositLimitMobile extends AbstractWhTestObject{
	...
	public static void main(String[] args) throws IOException, InterruptedException, AWTException {
		...
		String browserType = mainWebPage.getBrowserType();
	...
	public void depositLimit() throws IOException, InterruptedException, AWTException {
		...
		Function <Void, String> f = p -> {
			try {
				...
				MainWebPage mainWebPage ;//= ac.getBean(MainWebPage1.class);
...
//				depositPage.depositNext(50);
				Thread.sleep(3000);
				waitForElementSafeClick(driver, By.cssSelector("#application > div.page.fn-page > div.page-header.fn-header-container > div > button"), "click deposit");
				setDepositLimit(100);
	...
	private void compareDepositMsg(int amount, String lowerMsg, String uperMsg) throws InterruptedException {
		Thread.sleep(2000);
		try {
			//#layout-column__column-1 > div.portlet-wrapper.portlet-mobile-cashier.portlet_type_border > div.fn-portlet.portlet > ul > li.info-list__row.info-list__row_type_collapse.payment-method.fn-accordion.fn-deposit-method.accordion_expanded > div.info-list__field.fn-accordion-target.accordion-header_expanded
			waitForElement(driver, By.cssSelector("div.info-list__field.fn-accordion-target.accordion-header_expanded"), "open Visa").click();
		} catch (Exception e1) {}
