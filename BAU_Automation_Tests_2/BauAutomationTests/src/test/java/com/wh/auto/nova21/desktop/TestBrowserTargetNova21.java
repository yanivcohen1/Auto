 ...
 *
 */
public class TestBrowserTargetNova21 {
	...
	public static void main(String[] args) {
		TestBrowserTargetNova21 bt = new TestBrowserTargetNova21();
	...
	@BeforeClass
	public void before() {
		String BrowserTargetFile = Utility.getFilePathFromResource("Nova21\\BrowserTarget21Nova.csv");
