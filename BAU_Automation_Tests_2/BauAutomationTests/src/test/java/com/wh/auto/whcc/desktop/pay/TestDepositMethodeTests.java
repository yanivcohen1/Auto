...
public class TestDepositMethodeTests extends WebDriverUtils {
	...
	public static void main(String[] args) throws IOException, InterruptedException, AWTException {
		debug = true;
		TestDepositMethodeTests testDeposit21Nova = null;
		testDeposit21Nova = new TestDepositMethodeTests();
	 ...
	 * @throws AWTException 
	 */
	@Test(dataProvider = "Browsers", timeOut = 600000, retryAnalyzer=TestDepositMethodeTests.class, description = "Test The Registration & Deposit")//10 min timeout
	...
	private void depositTestDebug(String parametersFileName) throws AWTException, InterruptedException, IOException {
		...
		TestDepositMethodeTests testDeposit = ac.getBean(TestDepositMethodeTests.class);
		...
		driver.findElement(By.cssSelector("img[alt=\"PayPal\"]")).click();
		driver.findElement(By.id("D_Amount")).clear();
		driver.findElement(By.id("D_Amount")).sendKeys("10");
		
		// ERROR: Caught exception [ERROR: Unsupported command [waitForPopUp | DPYNewWin | 30000]]
		driver.findElement(By.cssSelector("div.header.clear")).click();
		driver.findElement(By.id("P_MoneybookersLogo")).click();
		driver.findElement(By.id("D_Amount")).clear();
		driver.findElement(By.id("D_Amount")).sendKeys("10");
		driver.findElement(By.cssSelector("ul[type=\"disc\"] > li")).click();
		driver.findElement(By.linkText("Close")).click();
		driver.findElement(By.id("PB_BackToCashierText")).click();
		driver.findElement(By.id("P_PaysafecardLogo")).click();
		driver.findElement(By.id("D_Amount")).clear();
		driver.findElement(By.id("D_Amount")).sendKeys("10");
		driver.findElement(By.cssSelector("img[alt=\"EcoAccount\"]")).click();
		driver.findElement(By.id("D_Amount")).clear();
		driver.findElement(By.id("D_Amount")).sendKeys("10");
		driver.findElement(By.id("PB_BackToCashierText")).click();
		driver.findElement(By.cssSelector("div.header.clear")).click();
		...
		Thread.sleep(5000);
		String balanceStr = waitForElement(driver, By.cssSelector(".balance-in-header"), 25).getText();
	...
	public void login(String userName, String password) throws InterruptedException{
		...
		driver.findElement(By.name("username")).sendKeys(userName);//"YY1005081227"
