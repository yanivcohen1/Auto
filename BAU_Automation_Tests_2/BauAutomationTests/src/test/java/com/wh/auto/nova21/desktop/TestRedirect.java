...
public class TestRedirect {
	...
	public void testRedirect() throws IOException, InterruptedException {
		...
		String Redirect21NovaFile = Utility.getFilePathFromResource("Nova21\\21NovaRedirect.csv");
		...
		for(ArrayList<String> urlList : urls){
			...
			int Len = url.length();
//			if (url.substring(Len-1, Len).contentEquals("/")) {
...
//					writer.flush();
//				}
//			}//else if (url.substring(Len-4, Len).contentEquals(".php")) {
			//	url= url.substring(0, Len-5) + ".html";
			//}
