...
public class TestLogin {
	...
	public static void main(String[] args) throws IOException, InterruptedException, AWTException {
		...
		testDeposit21Nova.depositTest("LoginDE.xml");//chrome,ie,firefox "Affutd.ini"
	...
	@BeforeClass
	public void beforeSuite(@Optional("LoginEN.xml")String parametersFileName) {
	...
	public void depositTest(String browserType) throws IOException, InterruptedException, AWTException {
		if (!debug) {
			for (int i = 0; i < maxRetryCount; i++) {
				try {
					depositTestDebug(browserType);
					break;
				} catch (Exception e) {
					e.printStackTrace();
