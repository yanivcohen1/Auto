...
public class TestDeposit21Nova {
	...
	public static void main(String[] args) throws IOException, InterruptedException, AWTException {
		debug = true;
		TestDeposit21Nova testRegistration = null;
		testRegistration = new TestDeposit21Nova();
		testRegistration.beforeSuite("");//classpath*:**/
		testRegistration.depositTest("nova21DepositEN.xml");//chrome,ie,firefox "Affutd.ini"
	}
	...
	@BeforeClass
	public void beforeSuite(@Optional("nova21DepositEN.xml") String parametersFileName) {
	...
	private void depositTestDebug(String parametersFileName) throws AWTException, InterruptedException, IOException {
		...
		registerPage.register();//myTestContext.getName()
		//start Deposit
