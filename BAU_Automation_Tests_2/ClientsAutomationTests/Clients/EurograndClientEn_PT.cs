...
namespace com.who.tests.clients
{
    ...
    ///</summary>
    [TestClass()]
    public class EurograndEnNew : Automation_Lib
    {
        ...
        {
            ctx = Commons.InitSpring("EurograndClientEn_PT_Context.xml");
            ...
            Thread.Sleep(10000);
            WriteToPlayersUsersfile(userName + ", " + "EuroClientEnPT");
        ...
        public void EurograndEnNewClient()
        {
            if (!bebug)
            {
                int trays = 3;
