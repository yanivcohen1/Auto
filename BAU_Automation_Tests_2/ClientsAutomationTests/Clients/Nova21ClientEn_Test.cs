...
namespace com.who.tests.clients
{
    ...
    ///</summary>
    [TestClass()]
    public class Nova21En : Automation_Lib
    {
        ...
        {
            ctx = Commons.InitSpring("Nova21ClientEnContext.xml");
            ...
            WriteToPlayersUsersfile(userName + ", " + "21novaClientEnNew");
