...
namespace com.who.tests.clients
{
    ...
    ///</summary>
    [TestClass()]
    public class Nova21De : Automation_Lib
    {
        ...
        ///The main test
        ///</summary>
        public void Nova21DeClientTestDebug()
        {
            ctx = Commons.InitSpring("Nova21ClientDeContext.xml");
            ...
            DownloadPage downloadPage = mainWebPage.ClickOnDownload(By.PartialLinkText("Herunterladen"));// By.PartialLinkText("Download")
            ...
            WriteToPlayersUsersfile(userName + ", " + "21novaClientDeNew");
            ...
            //Registration21novaPage registrationPage = (Registration21novaPage)ctx.GetObject(typeof(Registration21novaPage).Name);
            //string userName = "YAN" + GenerateUserName();
            //PopupMsgPage popupMsgPage = registrationPage.RegisterDataFill(userName);
            ////return new PopupMsgPage();
            ////PopupMsgPage popupMsgPage = congratulationsPage.LoginClick(userName);
            ////CashierPage cashierPage = popupMsgPage.clickCloseMsgEuro();
            //CashierPage cashierPage = (CashierPage)ctx.GetObject(typeof(CashierPage).Name);
            ////cashierPage.ClickOnCashier();
            //cashierPage.EnterDetails();
            //WriteToPlayersUsersfile(userName + ", " + "21novaClientDe");
            ////cashierPage.CloseApprovePopup();
            ////cashierPage.CloseBonusPopup();
