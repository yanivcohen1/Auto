...
namespace com.who.tests.clients
{
    ...
    ///</summary>
    [TestClass()]
    public class Nova21DeNew : Automation_Lib
    {
        ...
        ///The main test
        ///</summary>
        public void Nova21EnClientTestDebug()
        {
            ctx = Commons.InitSpring("Nova21ClientDe_PT_Context.xml");
            ...
            Registration21novaPage registration21novaPage = (Registration21novaPage)ctx.GetObject(typeof(Registration21novaPage).Name);
            string userName = "YAN" + GenerateUserName();
            registration21novaPage.RegisterDataFillChrome(userName);
            ...
            WriteToPlayersUsersfile(userName + ", " + "21NovaClientDePT");
