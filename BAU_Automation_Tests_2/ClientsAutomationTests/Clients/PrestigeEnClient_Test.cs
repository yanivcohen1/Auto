...
namespace com.who.tests.clients
{
    ...
    public class PrestigeEn : Automation_Lib
    {
        ...
        ///The main test
        ///</summary>
        public void PrestigeEnClientTestDebug()
        {
            ctx = Commons.InitSpring("PrestigeEnClientContext.xml");
            ...
            LicensePage licensePage;// = (LicensePage)ctx.GetObject(typeof(LicensePage).Name);
            try
            {
