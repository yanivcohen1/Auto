...
namespace com.who.tests.clients
{
    ...
    ///</summary>
    [TestClass()]
    public class WilliamhillNewDe : Automation_Lib
    {
        ...
        ///The main test
        ///</summary>
        public void WilliamhillDeClientTestDebug()
        {
            ctx = Commons.InitSpring("WilliamhillClientDePTContext.xml");
            ...
            DownloadPage downloadPage = mainWebPage.ClickOnDownload(By.CssSelector("#nav > li:nth-child(1) > a > span"));// By.PartialLinkText("Download")
           ...
           //joinNowPage.clickNextPageEuroNew();
            ...
            WriteToPlayersUsersfile(userName + ", " + "WhccClientDePT");
        ...
        public void Williamhill_DeNewClient()
        {
            if (!bebug)
            {
                int trays = 3;
