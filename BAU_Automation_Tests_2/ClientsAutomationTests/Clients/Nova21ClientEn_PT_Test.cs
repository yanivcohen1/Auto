...
namespace com.who.tests.clients
{
    ...
    ///</summary>
    [TestClass()]
    public class Nova21EnNew : Automation_Lib
    {
        ...
        {
            ctx = Commons.InitSpring("Nova21ClientEn_PT_Context.xml");
            ...
            Thread.Sleep(10000);
            WriteToPlayersUsersfile(userName + ", " + "21NovaClientEnPT");
