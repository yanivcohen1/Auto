...
namespace com.who.tests.clients
{
    ...
    ///</summary>
    [TestClass()]
    public class WilliamhillDe : Automation_Lib
    {
        ...
        {
            ctx = Commons.InitSpring("WilliamhillClientDeContext.xml");
            ...
            WriteToPlayersUsersfile(userName + ", " + "WhccClientDeNew");
        ...
        public void WilliamhillDeClient()
        {
            if (!bebug)
            {
                int trays = 3;
