...
namespace com.who.tests.clients
{
	...
	public class RegistrationEuroPage : Automation_Lib
	{
		...
		public GameModePage RegisterDataFillChrome(string userName)
		{
			...
			SendString("{Tab}");
			SendString("{Tab}");
			MouseClick(Convert.ToInt32(p.X + 704), Convert.ToInt32(p.Y + 485));
			Thread.Sleep(1500);
		...
		/// </summary>
		/// <returns></returns>
		public CongratulationsEuroPage RegisterDataFill(string userName)
		{
			...
			WriteText(editControls[8], userName);//user name
		...
		/// </summary>
		/// <returns></returns>
		public CongratulationsEuroPage RegisterDataFill_PT(string userName)
		{
			Condition controlNameCondition = new PropertyCondition(AutomationElement.NameProperty, CreateAccount);
			AutomationElement mainWindow = waitforWindowNameClass("PTIODEVICE", controlNameCondition, 30, false);
			setforgrandwindow(mainWindow);
			...
			//WriteText(editControls[3], Email);//email
			WriteText(editControls[4], Address);//Address
			WriteText(editControls[3], City);//city
		...
		/// </summary>
		/// <returns></returns>
		public CongratulationsEuroPage RegisterDataFillNew(string userName)
		{
			Condition controlNameCondition = new PropertyCondition(AutomationElement.NameProperty, CreateAccount);
