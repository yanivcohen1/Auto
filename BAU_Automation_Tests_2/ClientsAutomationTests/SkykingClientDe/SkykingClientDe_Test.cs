...
namespace SkykingClientDe
{
    ...
    ///</summary>
    [TestClass()]
    public class SkykingDe : Automation_Lib
    {
        ...
        ///The main test
        ///</summary>
        public void SkykingClientDeTestDebug()
        {
            ...
            GameModePage gameModePage = new GameModePage();//finishPage.DoneClick();
