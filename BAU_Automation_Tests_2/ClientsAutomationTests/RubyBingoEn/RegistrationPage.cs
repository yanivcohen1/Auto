...
namespace RubyBingoEn
{
    class RegistrationPage : Automation_Lib
    {
        ...
        /// </summary>
        public CongragulationPage FillRegisterDetail(string userName)
        {
            ...
            _driver.FindElement(By.Id("registrationForm:userDetailsSubview:usernameComponent:username")).SendKeys(userName);
            ...
            _driver.FindElement(By.Id("registrationForm:personalDetailsSubview:addressLine2Component:addressLine2")).SendKeys("addr1");
