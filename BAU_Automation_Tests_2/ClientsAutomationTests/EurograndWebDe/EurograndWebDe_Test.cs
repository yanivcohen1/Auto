...
namespace EurograndWebDe
{
    ...
    ///</summary>
    [TestClass()]
    public class EurograndWebDe : Automation_Lib
    {
        ...
        ///The main test
        ///</summary>
        public void EurograndWebDeTestDebug()
        {
            ...
            WriteToPlayersUsersfile(userName + ", EurograndWebDe");
        ...
        public void EurograndWebDeTest()
        {
            if (!bebug)
            {
                int trays = 3;
