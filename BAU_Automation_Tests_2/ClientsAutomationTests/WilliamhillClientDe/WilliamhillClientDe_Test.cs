...
namespace WilliamhillClientDe
{
    ...
    ///</summary>
    [TestClass()]
    public class WilliamhillClientDe : Automation_Lib
    {
        ...
        public void TestInitialize()
        {
                ...
                bebug = true;
            #endif
                Init(typeof(WilliamhillClientDe));
            driver = StartBrowser();
        }
        ...
        ///The main test
        ///</summary>
        public void WilliamhillClientDeTestDebug()
        {
        ...
        public void WilliamhillClientDeTest()
        {
            if (!bebug)
            {
                int trays = 3;
