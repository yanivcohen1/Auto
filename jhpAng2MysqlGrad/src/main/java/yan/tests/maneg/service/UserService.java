package yan.tests.maneg.service;

import yan.tests.maneg.domain.Authority;
import yan.tests.maneg.domain.User;
import yan.tests.maneg.repository.AuthorityRepository;
import yan.tests.maneg.config.Constants;
import yan.tests.maneg.repository.UserRepository;
import yan.tests.maneg.repository.search.UserSearchRepository;
import yan.tests.maneg.security.AuthoritiesConstants;
import yan.tests.maneg.security.SecurityUtils;
import yan.tests.maneg.util.RandomUtil;
