...
describe('Tests e2e test', () => {
    ...
    it('should load Tests', () => {
        ...
        expect(testsComponentsPage.getTitle()).toMatch(/testManagerApp.tests.home.title/);
    ...
    it('should load create Tests dialog', () => {
        ...
        expect(testsDialogPage.getModalTitle()).toMatch(/testManagerApp.tests.home.createOrEditLabel/);
