...
describe('Suite e2e test', () => {
    ...
    it('should load Suites', () => {
        ...
        expect(suiteComponentsPage.getTitle()).toMatch(/testManagerApp.suite.home.title/);
    ...
    it('should load create Suite dialog', () => {
        ...
        expect(suiteDialogPage.getModalTitle()).toMatch(/testManagerApp.suite.home.createOrEditLabel/);
