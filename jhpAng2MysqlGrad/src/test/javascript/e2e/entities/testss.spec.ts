...
describe('Testss e2e test', () => {
    ...
    it('should load Testsses', () => {
        ...
        expect(testssComponentsPage.getTitle()).toMatch(/testManagerApp.testss.home.title/);
    ...
    it('should load create Testss dialog', () => {
        ...
        expect(testssDialogPage.getModalTitle()).toMatch(/testManagerApp.testss.home.createOrEditLabel/);
