...
java -Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=9009 -jar build/libs/*.war
...
You can also use [Angular CLI version 1.5.0][] to generate some custom client code.
...
To optimize the TestManager application for production, run:
...
[Angular CLI version 1.5.0]: https://github.com/angular/angular-cli
