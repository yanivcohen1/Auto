package com.wh.auto.elasticSearch;
...
public class ElasticSearch {
    ...
    final static String ipAddr = "172.21.52.112";
    ...
    public static void main(final String[] args) throws IOException, InterruptedException {
    	...
    	elasticSearchAddResults("bau", "login", false, "this is gust a teste");
    }
    ...
    public static boolean elasticSearchAddResults(String suite, String testName, boolean isPass, String error_msg){
    	try {
            ...
            contentBuilder
	            .startObject()
		            ...
		            .field("suite", suite)//bau
		            .field("test", testName)//login
		            .field("pass", isPass)//true
		            .field("error_msg", error_msg)//error_msg
	            .endObject();
