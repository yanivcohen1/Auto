...
public class Browsers {
	...
	public WebDriver get_Driver(String browserType, String userAgent) throws IOException{
		...
		return get_Driver(browserType, userAgent, capabilities);
	}
	 ...
	 * @throws IOException
	 */
	public WebDriver get_Driver(String browserType, String userAgent, DesiredCapabilities capabilities) throws IOException{
		...
		if (browserType.contains("chrome")) {
			...
			try {
				...
				driver = getDriver(browserType, capabilities);
			}
