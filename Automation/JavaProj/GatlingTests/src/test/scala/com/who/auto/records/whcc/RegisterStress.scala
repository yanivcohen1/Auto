  ...
  var mainWS = "wss://oapi.digitalarea1000.com"
    ...
    .repeat(1, "i") {
     exec(ws("WS Register Test")
        .sendText("""3:::{"ID":31007,"responses":[33006,31008],"description":"Create Player Info (Register)","clientVersion":"10H","realMode":1,"casinoName":"whcasinoclub","changeTimestamp":"2017-1-29 13:37:40.484","dataMap":{"title":"Mrs","firstname":"asdasd","lastname":"asdasd","email":"test@playtech.com","userName":"yanyanyan","password":"123456","countrycode":"GB","address":"gyuygu","city":"sadasd","zip":"516556","cellphone":"+446456546","currencyCode":"GBP","birthdate":"1999-01-1","phone":"+441227768276","sex":"F","clienttype":"casino","tcVersion":"1.4","clientPlatform":"mobile","custom01":"yes","language":"EN","signupDeviceType":"nexus_5","signupOsName":"android","signupOsVersion":6,"signupDeliveryPlatform":"HTML5","signupDeviceBrowser":"chrome"}}""")
        ...
        .check(wsAwait.within(10).until(1)
          ...
          .transform(res => {
               println("body => " + res)
               if(res.contains(""""playerCode":63590395""")) "Reg pass"
                      else "fail"
              }
          )
          .is("Reg pass")
