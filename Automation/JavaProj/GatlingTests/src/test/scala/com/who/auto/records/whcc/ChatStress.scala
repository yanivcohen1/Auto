  ...
  val mainWS = "wss://oapi.digitalarea1000.com"
    ...
    .repeat(1, "i") {
     exec(ws("WS Chat Test")
        .sendText("""3:::{"ID":36000,"description":"Chat anonymous login","responses":[36001,36002],"clientType":"casino","clientPlatform":"mobile","clientVersion":"10H","languageCode":"en","casinoName":"whcasinoclub","clientSkin":"whcasinoclub"}""")
