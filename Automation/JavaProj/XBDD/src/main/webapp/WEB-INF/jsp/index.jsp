...
<title>Welcome to Yaniv BDD</title>
	...
	<nav class="navbar navbar-fixed-top navbar-inverse" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<a href="${pageContext.request.contextPath}/" class="navbar-brand">Yaniv BDD</a>
			</div>
		...
		<div class="row row-offcanvas row-offcanvas-right">
			<noscript>
				<div class="alert alert-danger" role="alert">
					...
					Enable JavaScript to use BDD
				</div>
			</noscript>
			<div class="jumbotron">
				<h1>Welcome to Yaniv BDD</h1>
				<p class="lead">
				<%
