...
namespace SkykingClientDe
{
    ...
    public class DepositPage : Automation_Lib
    {
        ...
        {
            Condition controlNameCondition = new PropertyCondition(AutomationElement.NameProperty, "Einzahlung ");
            ...
            AutomationElementCollection textControl = mainWindow.FindAll(TreeScope.Element | TreeScope.Descendants, controlCondition);
            ClickElement(textControl[1]);
        ...
        {
            Condition controlNameCondition = new PropertyCondition(AutomationElement.NameProperty, "Ihre Kreditkarten-Einzahlung wurde genehmigt und erscheint als WHG Online/AquaPay London. Vielen Dank und viel Glück!");
        ...
        {
            Condition controlNameCondition = new PropertyCondition(AutomationElement.NameProperty, "Balance:");
