...
namespace RubyBingoEn
{
    public class MainGamePage : Automation_Lib
    {
        ...
        {
            Thread.Sleep(10000);
            Condition controlCondition = new PropertyCondition(AutomationElement.LocalizedControlTypeProperty, "document");
            ...
            WriteToPlayersUsersfile("YANQAN" + _userName + password + ", RubyBingoEn");
