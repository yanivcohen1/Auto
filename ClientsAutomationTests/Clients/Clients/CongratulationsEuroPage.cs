...
namespace com.who.tests.clients
{
    ...
    public class CongratulationsEuroPage : Automation_Lib
    {
        ...
        /// </summary>
        /// <returns></returns>
        public PopupMsgPage LoginClick(string passwordFileName)
        {
            string login = Login;
            ...
            string passwordPath = _rootPath + passwordFileName;// "/EurograndClientEn/PasswordEuro.txt";
            string password = File.ReadAllText(passwordPath);
            WriteToPlayersUsersfile(UserName + _userName + password + ", " + PlayersUsersFile);
