...
namespace com.who.tests.clients
{
    ...
    ///</summary>
    [TestClass()]
    public class JoylandDe : Automation_Lib
    {
        ...
        ///The main test
        ///</summary>
        public void JoylandDeClientTestDebug()
        {
            ctx = Commons.InitSpring("JoylandDeClientContext.xml");
