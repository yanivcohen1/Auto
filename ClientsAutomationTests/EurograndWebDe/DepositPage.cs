...
namespace EurograndWebDe
{
    ...
    public class DepositPage : Automation_Lib
    {
        ...
        public void Deposit()
        {
            ...
            //click on deposit
            Condition controlCondition = new PropertyCondition(AutomationElement.NameProperty, "Registrierung abgeschlossen");
            AutomationElement mainWindow = waitforWindowNameClass("Registrierung abgeschlossen - Google Chrome", controlCondition, 30, true);
            Rect rect = mainWindow.Current.BoundingRectangle;
            System.Drawing.Point p = Cursor.Position;
            int x = Convert.ToInt32(rect.Left) + 690;//690, 358 690, 381
            int y = Convert.ToInt32(rect.Top) + 381;
            MouseClick(x, y);
        }
