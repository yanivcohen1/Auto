...
namespace JoylandClientDe
{
    ...
    public class CongratulationsPage : Automation_Lib
    {
        ...
        public PopupMsgPage LoginClick()
        {
            ...
            WriteToPlayersUsersfile(userName + ", JoylandClientDe");
        ...
        private ScrollItemPattern ScrollIntoView(AutomationElement targetControl)
        {
            ScrollItemPattern scrollItemPattern = null;
            try
            {
                Rect rect = targetControl.Current.BoundingRectangle;
                //System.Drawing.Point p = Cursor.Position;
                int x = Convert.ToInt32(rect.Left) + 364;
                int y = Convert.ToInt32(rect.Top) + 241;
                MouseClick(x, y);
                scrollItemPattern =targetControl.GetCurrentPattern(ScrollItemPattern.Pattern)
