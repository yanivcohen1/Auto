...
import com.who.auto.web.rest.dto.ManualTestIn;
import com.who.auto.web.rest.dto.ManualTestOut;
...
public class ManualRestService {
	...
	private final Logger log = LoggerFactory.getLogger(ManualRestService.class);
    ...
    @Timed
  	public ManualTestOut runManualTest(@RequestBody ManualTestIn manualTestIn) throws IOException {
