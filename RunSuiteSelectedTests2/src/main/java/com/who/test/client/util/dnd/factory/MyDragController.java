 ...
 * the License.
 */
package com.who.test.client.util.dnd.factory;
 ...
 */
public abstract class MyDragController extends SimplePanel {
   ...
   */
  public MyDragController(DragController dragController) {
    this();
   ...
   * draggable by calling {@link MyDragController#makeDraggable(Widget)}.
   * 
