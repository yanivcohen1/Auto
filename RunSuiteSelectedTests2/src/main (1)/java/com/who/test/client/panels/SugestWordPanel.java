...
public class SugestWordPanel extends Composite implements IConstants  {
	...
	/**
	  ...
	  public Widget onInitialize() {
	    ...
	    horizontalPanel.setStyleName("backgrownd");
	    ...
	    suggestBox.setSize("176px", "18px");
	    //oracle.add("yaniv");
	    Button btnNewButton = new Button("Search Button");
	    btnNewButton.setStyleName("gwt-Button-blue");
	    ...
	    btnNewButton.setSize("", "30px");
	    
	    Grid grid = new Grid(1, 1);
	    horizontalPanel.add(grid);
	    grid.setWidth("36px");
	    
	    Image image = new Image("WHO.png");
	    
	    horizontalPanel.add(image);
	    image.setSize("84px", "30px");
