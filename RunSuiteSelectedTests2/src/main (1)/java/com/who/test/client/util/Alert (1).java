...
public class Alert {
	...
	final static Button okButton = new Button("Ok");
	final static Button cancelButton = new Button("Cancel");
	...
	public static void dialogConfirm(String msg , String header, final DialogCallback dialogCallback) {
