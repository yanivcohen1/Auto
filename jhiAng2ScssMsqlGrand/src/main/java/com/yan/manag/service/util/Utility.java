...
import com.yan.manag.web.websocket.ActivityService;
...
public class Utility {
	...
	private static byte[] readFile(String id) throws IOException {
		...
		return org.apache.commons.io.IOUtils.toByteArray(file.getInputStream());
	}
