...
export class UploadPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.bddService.getHero(id).subscribe((testss) => {
                   if (testss.dates) {
                        testss.dates = {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.testssModalRef(component, new Hero('0', 'new hero'));
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    testssModalRef(component: Component, hero: Hero): NgbModalRef {
