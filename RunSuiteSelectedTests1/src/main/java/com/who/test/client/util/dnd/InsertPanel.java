 ...
 * the License.
 */
package com.who.test.client.util.dnd;
 ...
 * between columns.
 */
public final class InsertPanel extends MyDragController {
  ...
  public InsertPanel(MyDragHandler demoDragHandler) {
  ...
  public Class<?>[] getInvolvedClasses() {
    return new Class[] {
        InsertPanel.class, VerticalPanelDropController.class, VerticalPanelWithSpacer.class,
