...
public class ManagePanel extends Composite implements ISearchFilter {
	...
	private NewPanelWidg newPanelWidg = new NewPanelWidg();
	...
	public ManagePanel() {
	    ...
	    btnDelete.setStyleName("gwt-Button padding");
	...
	protected void loadNewPanel() {
		...
		newPanelWidg.setNew(true);
		newPanelWidg.setContainerPanel(flowPanel);
		flowPanel.clear();
	...
	public String executeFilter(String searchWord) {
		if (!searchWord.trim().isEmpty()) {
			...
			for (TestsData testData : testsData) {
				if (testData.getTestName().contains(searchWord)) {
