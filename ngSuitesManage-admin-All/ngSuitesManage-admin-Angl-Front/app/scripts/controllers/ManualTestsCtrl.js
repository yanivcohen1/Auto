...
angular.module('ngSuitesManageAdminYeomanApp').controller('ManualTestsCtrl',['$scope', '$log', '$window', '$http', '$q', '$resource', 'uiGridConstants', '$location', 
    ...
    $scope.runTest = function(){
    	if ($scope.run === "Stop Test") {
    	  ...
    	  $scope.responses = [];
    	  $scope.doneLoading = false;
    	  var manualTests_url = AppConfig.apiServiceBaseUri() + '/rest/manualTests/';
