	        ...
	        .state('/tests',
	        	...
	        	resolve: {
	        		LazyLoad: [ '$location', '$ocLazyLoad',function ($location, $ocLazyLoad) {
	                	return  $ocLazyLoad.load('scripts/controllers/ManualTestsCtrl.js');
	                }]
	              },
	        	url: "/manualTests",
	        	views: {
			        "main": { controller: 'ManualTestsCtrl',
				        	  templateUrl: 'views/ManualTests.html',
				              secure: false }
	        	}
		        })
	        .state('jenkinsManual', {
	        	resolve: {
	        		LazyLoad: [ '$location', '$ocLazyLoad',function ($location, $ocLazyLoad) {
	                	return  $ocLazyLoad.load('scripts/controllers/JenkinsManualCtrl.js');
	                }]
	              },
	        	url: "/jenkinsManual",
	        	views: {
			        "main": { controller: 'ManualCtrl',
				        	  templateUrl: 'views/jenkinsManual.html',
				              secure: false }
	        	}
		        });
