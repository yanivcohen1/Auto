...
public class Ang2MongMvnApp {

    private static final Logger log = LoggerFactory.getLogger(Ang2MongMvnApp.class);

    private final Environment env;

    public Ang2MongMvnApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes Ang2MongMvn.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Ang2MongMvnApp.class);
