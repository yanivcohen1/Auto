...
app.service('testsService', function ($resource, $rootScope, ngAuthSettings) {
    ...
    this.readTests = function (suiteId) {
        var Tests =  $resource(ngAuthSettings.apiServiceBaseUri +'/rest/tests/readAllTests/:id', { id: '@id' }, {
    ...
    this.saveTests = function (tests) {
    	var Tests = $resource(ngAuthSettings.apiServiceBaseUri+'/rest/tests/updateTests', {}, {
            save: { method: 'POST'
            	}
        });
    ...
    this.deleteTest = function (id) {
        var Tests = $resource(ngAuthSettings.apiServiceBaseUri + '/rest/tests/deleteTest/:id', { id: '@id' }, {
            query: {
                method: 'GET',
                params: {},
                isArray: false
    ...
    this.newTest = function (suiteName, testName, classesNamef, parametersNamef, parametersValuef) {
    	var Tests = $resource(ngAuthSettings.apiServiceBaseUri + '/rest/tests/newTest', {}, {
            save: { method: 'POST'
            	}
        });
    ...
    this.updateTest = function (suiteId, suiteName, testId, TestName,
        ...
        var Tests = $resource(ngAuthSettings.apiServiceBaseUri + '/rest/tests/updateTest', {}, {
            save: { method: 'POST'
            	}
        });
