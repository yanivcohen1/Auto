...
import com.who.rest.dao.jpa.IJpaClasseDao;
import com.who.rest.dao.jpa.IJpaParametersDao;
...
import com.who.rest.dto.TestsData;
import com.who.rest.dto.TestsDataFlat;
...
public class TestsUtil extends Common{
	...
	@Autowired
	private IJpaClasseDao jpaClasseDao;
	
	@Autowired
	private IJpaParametersDao jpaParametersDao;
	...
	public List<String> GetSuiteTests(String suiteName) {
		...
		List<Tests> tests = jpaTestsDao.runQuery(query);
	...
	public List<String> getAllSuitsNames() {
		...
		List<Suites> suites = jpaSuitesDao.runQuery(query);
	...
	public boolean addTest(TestsDataFlat testsData) throws IllegalArgumentException {
			try {
				...
				for (int i = 0; i < testsData.getParametersNames().size(); i++) {
					...
					jpaParametersDao.save(parameters);
				}
