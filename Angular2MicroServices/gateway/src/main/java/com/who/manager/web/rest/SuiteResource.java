...
import com.who.manager.service.SuiteService;
...
public class SuiteResource {
    ...
    public SuiteResource(SuiteService suiteService) {
    ...
    public ResponseEntity<Suite> createSuite(@Valid @RequestBody Suite suite) throws URISyntaxException {
        ...
        Suite result = suiteService.save(suite);
     ...
     * or with status 500 (Internal Server Error) if the suite couldnt be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/suites")
    @Timed
    ...
    public ResponseEntity<List<Suite>> getAllSuites(@ApiParam Pageable pageable)
        ...
        Page<Suite> page = suiteService.findAll(pageable);
    ...
    public ResponseEntity<Suite> getSuite(@PathVariable Long id) {
        ...
        Suite suite = suiteService.findOne(id);
    ...
    public ResponseEntity<List<Suite>> searchSuites(@RequestParam String query, @ApiParam Pageable pageable)
        ...
        Page<Suite> page = suiteService.search(query, pageable);
