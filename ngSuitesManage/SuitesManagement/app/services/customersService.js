...
app.service('suitesService', function ($resource) {
    ...
    this.readSuites = function ($resource) {
        return $resource('http://localhost:8080/ngSuitesManage/rest/suites/readAllSuites', {}, {
    ...
    this.saveSuites = function ($resource) {
        return $resource('http://localhost:8080/ngSuitesManage/rest/suites/updateSuites', {}, {
            save: { method: 'POST' }
        })
    };

    this.deleteSuite = function ($resource) {
        return $resource('http://localhost:8080/ngSuitesManage/rest/suites/deleteSuite/:id', { id: '@id' }, {
            query: {
                method: 'GET',
                params: {},
                isArray: false
    ...
    this.newSuite = function ($resource) {
        return $resource('http://localhost:8080/ngSuitesManage/rest/suites/newSuite', {}, {
            save: { method: 'POST' }
        })
    };
